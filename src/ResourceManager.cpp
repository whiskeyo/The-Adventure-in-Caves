...
ResourceManager::ResourceManager() {
  loadTextureFromMemory(&TEXTURE_background1, sizeof(TEXTURE_background1),
                        "background1");
  loadTextureFromMemory(&TEXTURE_background2, sizeof(TEXTURE_background2),
                        "background2");
  loadTextureFromMemory(&TEXTURE_background3, sizeof(TEXTURE_background3),
                        "background3");
  loadTextureFromMemory(&TEXTURE_background4, sizeof(TEXTURE_background4),
                        "background4");
  loadTextureFromMemory(&TEXTURE_background5, sizeof(TEXTURE_background5),
                        "background5");
  loadTextureFromMemory(&TEXTURE_background6, sizeof(TEXTURE_background6),
                        "background6");
  ...
  loadTextureFromMemory(&TEXTURE_portal_bright, sizeof(TEXTURE_portal_bright),
                        "portal_bright");
  loadTextureFromMemory(&TEXTURE_portal_dark, sizeof(TEXTURE_portal_dark),
                        "portal_dark");
  loadTextureFromMemory(&TEXTURE_enemy_weak_left,
                        sizeof(TEXTURE_enemy_weak_left), "enemy_weak_left");
  loadTextureFromMemory(&TEXTURE_enemy_weak_right,
                        sizeof(TEXTURE_enemy_weak_right), "enemy_weak_right");
  loadTextureFromMemory(&TEXTURE_enemy_strong_left,
                        sizeof(TEXTURE_enemy_strong_left), "enemy_strong_left");
  loadTextureFromMemory(&TEXTURE_enemy_strong_right,
                        sizeof(TEXTURE_enemy_strong_right),
                        "enemy_strong_right");
  loadFont("assets/fonts/04B_30__.TTF", "hud");
}
...
void ResourceManager::loadTextureFromMemory(const void *data, std::size_t size,
...
void ResourceManager::loadFontFromMemory(const void *data, std::size_t size,
