// In these file there are main properties
...
// Menu:
#define M_BUTTONS_COUNT 3
#define M_BUTTON_W      400
#define M_BUTTON_H      100
#define M_SELECTED      sf::Color::Red
#define M_UNSELECTED    sf::Color::White

// World:
#define G_BOUND_COLOR sf::Color(20, 24, 30) // 10, 100, 155
